...
class AddHealthPass extends StatefulWidget {
  ...
  @override
  _AddHealthPassState createState() => _AddHealthPassState();
}

class _AddHealthPassState extends State<AddHealthPass> {
  @override
              ...
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "NUMÉRO DE TÉLÉPHONE LORS DE VOTRE ENROLEMENT",
                      style: TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.w600,
                      ),
